    ...
    private static List<Poi> ParsePois(JsonElement? element)
    {
        ...
        foreach (var (item, key) in EnumerateCollection(element.Value))
        {
            ...
            var poi = new Poi
            {
                ...
                HistoryEn = ReadString(item, "historyEn", "history_en"),
                HistoryJp = ReadString(item, "historyJp", "history_jp", "historyJa", "history_ja"),
                HistoryZh = ReadString(item, "historyZh", "history_zh"),
                HistoryRu = ReadString(item, "historyRu", "history_ru"),
                HistoryFr = ReadString(item, "historyFr", "history_fr"),
                Address = ReadString(item, "address"),
                AdrEn = ReadString(item, "adrEn", "adr_en", "addressEn", "address_en"),
                AdrJp = ReadString(item, "adrJp", "adr_jp", "adrJa", "adr_ja", "addressJp", "address_jp", "addressJa", "address_ja"),
                AdrZh = ReadString(item, "adrZh", "adr_zh", "addressZh", "address_zh"),
                AdrRu = ReadString(item, "adrRu", "adr_ru", "addressRu", "address_ru"),
                AdrFr = ReadString(item, "adrFr", "adr_fr", "addressFr", "address_fr"),
