...
if (!$id) {
    header('Location: owner_pois.php');
    exit;
}
...
if (!$poi || !isset($poi['OwnerId']) || $poi['OwnerId'] != $_SESSION['user_id']) {
    ...
    die('Forbidden: Bạn không có quyền truy cập POI này.');
}
...
<head>
    ...
    <title>Chi tiết POI - Vĩnh Khánh Admin</title>
        ...
        <main class="main-content">
            <header class="header">
                <div style="display: flex; gap: 10px; align-items: center;">
                    <a href="owner_pois.php" class="btn btn-back">← Quay lại</a>
            ...
            <div class="card" style="margin-bottom: 1.5rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                    ...
                    <a href="owner_poi_form.php?id=<?php echo $id; ?>" class="btn-edit" style="color: #fff; border: 1px solid #f59e0b; background: transparent;">Chỉnh sửa POI</a>
                </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value">
                                <span class="badge <?php echo isset($poi['IsActive']) && $poi['IsActive'] ? 'badge-active' : 'badge-inactive'; ?>">
                                    <?php echo isset($poi['IsActive']) && $poi['IsActive'] ? 'Active' : 'Hidden'; ?>
                                </span>
                            </div>
                        </div>
                        <div class="detail-row">
