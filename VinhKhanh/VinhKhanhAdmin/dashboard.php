...
$pendingPois = count(array_filter($pois, function($p) { return $p && isset($p['IsActive']) && $p['IsActive'] == 2; }));
        ...
        <main class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card" style="border-top-color: #f59e0b;">
                    <h3>Pending POIs (Chờ duyệt)</h3>
                    <p class="stat-value" style="color: #f59e0b;"><?php echo $pendingPois; ?></p>
                </div>
                <div class="stat-card">
                    <h3>Categories</h3>
